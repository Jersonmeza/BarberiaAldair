...
if(isset($_REQUEST['consultar'])){
	$identificacion=$_REQUEST['identificacion'];
		...
		$consultar="SELECT * FROM barberos WHERE Bb_id=$identificacion"; 
		$frespuesta=mysqli_query($link,$consultar);
		$frow=mysqli_fetch_array($frespuesta, MYSQLI_ASSOC);
			
			if(empty($frow)) {
			echo "<script languaje='javascript'>alert('El barbero no existe.')</script>";
			$identificacion="";
			}
			else{
			$identificacion=$frow['Bb_id'];
            $nombre=$frow['Bb_Nombres'];
            $celular=$frow['Bb_Celular'];
            $email=$frow['Bb_Email'];
			$direccion=$frow['Bb_Drcc'];
            $HoraIni=$frow['Bb_HorarioInic'];
            $HoraFin=$frow['Bb_HorarioFinal'];
			}
		}
    }
	...
	if(isset($_REQUEST['actualizar'])){
        ...
        if(!empty($identificacion)){
            ...
            $actualizar="UPDATE barberos SET Bb_Nombres='$nombre', Bb_Celular='$celular', Bb_Email='$email', Bb_Drcc='$direccion', Bb_HorarioInic='$HoraIni', Bb_HorarioFinal='$HoraFin' where Bb_id=$identificacion";
	...
	if(isset($_REQUEST['eliminar'])) {
        $identificacion=$_REQUEST['identificacion'];
            ...
            if(!empty($_REQUEST['identificacion'])){
            $eliminar="DELETE FROM barberos WHERE Bb_id=$identificacion";
					...
					<div class="wrap-input100 " data-validate = "Ingrese su numero de Celular" >
						...
						<div class="wrap-input100 " data-validate = "Ingrese su Email" >
							...
							<div class="wrap-input100 " data-validate = "Ingrese su Direccion" >
                                ...
                                <div class="wrap-input100 " data-validate = "Ingrese su Hora de inicio" >
									<input class="input100" type="text" name="horainicio" placeholder="Hora de Inicio" value="<?php echo $HoraIni; ?>">
									<span class="focus-input100" data-placeholder=""></span>
                                </div>
                                
                                <div class="wrap-input100 " data-validate = "Ingrese su Hora final" >
									<input class="input100" type="text" name="horafinal" placeholder="Hora Final" value="<?php echo $HoraFin; ?>">
									<span class="focus-input100" data-placeholder=""></span>
								</div>
